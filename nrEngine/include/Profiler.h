...
#   define NR_Profile( a )      ::nrEngine::Profile __nr_profile_instance( (a) )
#   define NR_ProfileBegin( a ) ::nrEngine::Profiler::GetSingleton().beginProfile( (a) )
#   define NR_ProfileEnd( a )   ::nrEngine::Profiler::GetSingleton().endProfile( (a) )
#else
#   define NR_Profile( a )
...
#   define _nrEngineProfile( a )      ::nrEngine::Profile __nr_profile_instance( (a) )
#   define _nrEngineProfileBegin( a ) ::nrEngine::Profiler::GetSingleton().beginProfile( (a) )
#   define _nrEngineProfileEnd( a )   ::nrEngine::Profiler::GetSingleton().endProfile( (a) )
#else
...
namespace nrEngine{
	 ...
	 * \ingroup gp
	 **/
	class _NRExport Profiler : public ISingleton<Profiler>{
		public:
