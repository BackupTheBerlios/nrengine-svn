...
namespace nrEngine {
	...
	*	- In each game cycle \a ITask::taskUpdate() Method will be executed
	*	- By suspending or resuming the Tasks \a ITask::taskOnSuspend()/taskOnResume() Method will be executed
	*	- Before task will be removed \a ITask::taskStop() Method will executed
