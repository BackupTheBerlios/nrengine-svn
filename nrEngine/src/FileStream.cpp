...
namespace nrEngine {
	...
	//----------------------------------------------------------------------------------
	FileStream::FileStream() : IStream(0), IResource()
	{
	}
	...
	//----------------------------------------------------------------------------------
	Result FileStream::reloadRes()
	{
		Result ret = IResource::reloadRes();
		if (ret != OK) return ret;

		mResDataSize += mStreamBufSize;

		return OK;
	}

	//----------------------------------------------------------------------------------
	Result FileStream::unloadRes()
	{
	...
	//----------------------------------------------------------------------------------
	Result EmptyFileStream::unloadRes(){
		return OK;
	}

	//----------------------------------------------------------------------------------
	Result EmptyFileStream::reloadRes(){
		return OK;
	}
